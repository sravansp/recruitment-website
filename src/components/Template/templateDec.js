...
import {
  ...
  updateRecruitmentJobDescriptionTemplate,
  saveRecruitmentJobDescriptionTemplate,
  ...
  const handlesubmit = async (e) => {
    try {
      ...
      if (!templateName) {
        ...
        templateName === JobDescription[0]?.descriptionTemplateName
      ) {
              ...
              <div className="flex items-center px-1.5  ">
                ...
                <div className="flex flex-col gap-1 p-1.5">
                  ...
                  <p className="text-gray-400">
                    When you generate with Al, we look for similar jobs you've
                    created in the past and use the data to create content
                    that's impactful, accurate and personalized to your company.
                  </p>
                </div>
              </div>
            </div>
          ...
          <DownOutlined />
            ...
            <div className="pt-5">
              ...
              <TextEditor
                ...
                placeholder={
                  "Enter the job description here, include key areas of resposibility on what the candidate might do on a typical day."
                }
                error={contentError}
                loader={loader}
              />
