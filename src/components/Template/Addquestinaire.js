...
import { saveRecruitmentQuestionnaireTemplate, saveRecruitmentQuestionnaireTemplateDetailBatch } from '../Api1'
        ...
        if (response.status === 200) {
          ...
          setEvaluation((prevEvaluation) => {
            return prevEvaluation.map((item) => ({
              ...item,
              questionnaireTemplateId: parseInt(response.result.insertedId),
  ...
  return (
    <div>
      ...
      <DrawerPop
        ...
        className="widthFull"
       handleSubmit={(e)=>{formik.handleSubmit()}}
