...
import { MdContentCopy, MdOutlineShortText } from "react-icons/md";
    ...
    onSubmit: async (e) => {
      if (formik1.values.noOfVaccancies && formik1.values.noOfVaccancies <= 0) {
        formik1.setFieldError(
          "noOfVaccancies",
          "Openings should be a positive value"
        );
        return;
      }
      if (
        !formik1.values.jobTitle ||
        !formik1.values.departmentId ||
        !formik1.values.jobCode ||
        ...
        formik1.setFieldError(
          "companyId",
          !formik1.values.companyId ? "Company  is required" : ""
        );
        formik1.setFieldError(
          "jobTitle",
          !formik1.values.jobTitle ? "Job Title is required" : ""
        );
        formik1.setFieldError(
          "departmentId",
          !formik1.values.departmentId ? "Department is required" : ""
        );
        formik1.setFieldError(
          "jobCode",
          !formik1.values.jobCode ? "Job Code is required" : ""
        );
        formik1.setFieldError(
          "location",
          !formik1.values.location ? "Location is required" : ""
        );
        formik1.setFieldError(
          "requirementType",
          !formik1.values.requirementType ? "Requirment is required" : ""
        );
        formik1.setFieldError(
          "experience",
          !formik1.values.experience ? "Experience is required" : ""
        );
        formik1.setFieldError(
          "searchKeywords",
          !formik1.values.searchKeywords ? "Keywords is required" : ""
        );
        formik1.setFieldError(
          "salaryRangeFrom",
          !formik1.values.salaryRangeFrom ? "Salary Range From is required" : ""
        );
        formik1.setFieldError(
          "salaryRangeTo",
          !formik1.values.salaryRangeTo ? "Salary Range To is required" : ""
        );
        formik1.setFieldError(
          "salaryCurrency",
          !formik1.values.salaryCurrency ? "Salary Currency is required" : ""
        );
        formik1.setFieldError(
          "jobType",
          !formik1.values.jobType ? "Job Type is required" : ""
        );
        formik1.setFieldError(
          "education",
          !formik1.values.education ? "Education is required" : ""
        );
        formik1.setFieldError(
          "jobDescription",
          !content ? "Job Description is required" : ""
        );
        formik1.setFieldError(
          "noOfVaccancies",
          !formik1.values.noOfVaccancies ? "Number of Openings is required" : ""
        );
        return;
      }
      try {
    ...
    switch (activeBtnValue) {
      case "Jobdetails":
        if (content && content.length < 3) {
          formik1.setFieldError(
            "jobDescription",
            "Job Description should have at least 3 letters."
          );
          return;
        }
    ...
    try {
      ...
      if (response.result.length > 0) {
        ...
        formik.setFieldValue(
          "headline",
          firstJob.jobApplicationFormData.headline
        );
        formik.setFieldValue("phone", firstJob.jobApplicationFormData.phone);
        formik.setFieldValue(
          "address",
          firstJob.jobApplicationFormData.address
        );
        formik.setFieldValue(
          "country",
          firstJob.jobApplicationFormData.country
        );
        formik.setFieldValue(
          "education",
          firstJob.jobApplicationFormData.education
        );
        formik.setFieldValue(
          "experience",
          firstJob.jobApplicationFormData.experience
        );
        formik.setFieldValue(
          "summary",
          firstJob.jobApplicationFormData.summary
        );
        formik.setFieldValue("resume", firstJob.jobApplicationFormData.resume);
        formik.setFieldValue(
          "coverLetter",
          firstJob.jobApplicationFormData.coverLetter
        );
        getDepartmentList(firstJob.companyId);
      }
    } catch (error) {
                      ...
                      {inputshow && (
                        <div className="grid grid-cols-3 gap-6 ">
                          ...
                          <Dropdown
                            ...
                            options={company}
                            value={
                              isNaN(formik1.values.companyId)
                                ? null
                                : formik1.values.companyId
                            }
                        ...
                        {regularOvertime?.map((each, i) => (
                          <div
                            ...
                            className={`col-span-4 p-1.5 border rounded-2xl cursor-pointer showDelay dark:bg-dark ${
                              (!formik1.values.workLocationType &&
                                each.value === "Onsite") ||
                            ...
                            onClick={() => {
                              ...
                              formik1.setFieldValue(
                                "workLocationType",
                                each.value === "Onsite" ? "Onsite" : each.value
                              );
                            }}
                          >
                      ...
                      <div className="grid grid-cols-4 gap-4">
                        <FormInput
                          ...
                          change={(e) => {
                            ...
                            const salaryRangeTo = parseFloat(
                              formik1.values.salaryRangeTo
                            );
                            ...
                            if (value <= 0) {
                              formik1.setFieldError(
                                "salaryRangeFrom",
                                "Salary Range From must be a positive number"
                              );
                            } else {
                          ...
                          value={
                            isNaN(formik1.values.salaryRangeFrom)
                              ? ""
                              : formik1.values.salaryRangeFrom
                          }
                          type={"text"}
                          ...
                          inputmode="numeric"
                          error={
                            formik1.errors.salaryRangeFrom ||
                        ...
                        <FormInput
                          ...
                          value={
                            isNaN(formik1.values.salaryRangeTo)
                              ? ""
                              : formik1.values.salaryRangeTo
                          }
                          error={
                            formik1.errors.salaryRangeTo || salaryRangeToError
                          }
                          required={true}
                          type={"text"}
                          pattern="[0-9]*"
                    ...
                    >
                      ...
                      <div class="flex flex-col gap-4 overflow-hidden">
                            ...
                            <div className="flex flex-col gap-1 p-1.5">
                              <div className="flex items-center justify-between ">
                                <p className="font-bold">
                                  Generate personalized job descriptions based
                                  on past account data.
                                </p>
                                {/* <p className="text-primary"><IoClose /></p> */}
                              </div>
                              <p className="text-gray-400">
                                When you generate with Al, we look for similar
                                jobs you've created in the past and use the data
                                to create content that's impactful, accurate,
                                and personalized to your company
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <ButtonClick
                            handleSubmit={handleGenerateWithAI}
                            BtnType="primary"
                            icon={
                              <img
                                src={image}
                          ...
                          <>
                            <div className="flex items-center justify-between ">
                              <FormInput
                                ...
                                error={
                                  condition.question ? "" : Questionerror || ""
                                }
                                maxLength={100}
                              />
                            ...
                            {condition.answerMetaData[0]?.key && (
                              <>
                                {[
                                  ...
                                  "Multiple Choice",
                                  "Checkboxes",
                                ].includes(condition.answerMetaData[0]?.key) &&
                ...
                */}
                    ...
                    >
                      {Stages.map((each) => (
                        <div
                          key={each.workFlowId}
                          className={`  relative p-2.5  mt-6 border rounded-md ${
                            selectedWorkFlowId === each.workFlowId
                              ? "bg-[#F2F0FD]  border-[#6A4BFC]"
                              : ""
                          }`}
                        >
                      ...
                      <div className="flex items-center gap-2">
                        <CheckBoxInput
                          change={(e) => {
                            ...
                            if (isChecked) {
                              const allUserIds = employeeList.map(
                                (employee) => employee.userId
                              );
                              const allSelectedEmployees = employeeList.map(
                                (employee, index) => ({
                                  id: index + 1,
                            ...
                            <tr>
                              <td>
                                <CheckBoxInput
                                  ...
                                  value={
                                    CheckboxValue ||
                                    selectedUserIds.includes(employee.userId)
                                  }
                    ...
                    <div className="flex flex-col gap-6 lg:col-span-8">
                      <div className="flex flex-wrap gap-6 ">
                        ...
                        {data.map((item, index) => (
                          <div
                            key={index}
                            className={`bg-white dark:bg-black rounded-md border-[1px]  p-2 w-[291px] h-[68px] ${
