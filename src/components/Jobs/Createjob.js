                      ...
                      >
                        <Card>
                          <div>
                            <img alt=""></img>
                            <p>
                              Generate personalized job descriptions based on
                              pas account data.
                            </p>
                            <p>
                              When you generate with Al, we look for similar
                              jobs you've created in the past and use he data to
                              create content that's impactful, accurate, and
                        ...
                        >
                          <ButtonClick
                           buttonName="Choose Job Description"
                           icon={ <DownOutlined />}>
                            <Space>
