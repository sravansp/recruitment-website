...
const SmallScreenMenu = () => {
  ...
  return (
    <aside
      ...
      } fixed dark:!bg-black bg-primary h-full w-16 2xl:w-[88px] !py-5 !px-3 ${
        menuView === true ? "open" : "close"
      }`}
    >
          ...
          >
            <span
              className={`line w-3 2xl:w-[18px] h-[0.12rem] rounded-md bg-gray-100 block mx-auto transition-all duration-300 ease-in-out transform ${
                menuView === true ? "translate-x-[3px]" : ""
              }`}
            ></span>
            <span
              className={`line w-3 2xl:w-[18px] h-[0.12rem] rounded-md bg-gray-100 block mx-auto transition-all duration-300 ease-in-out transform ${
                menuView === true ? "" : "translate-x-0"
              }`}
            ></span>
            <span
              className={`line w-3 2xl:w-[18px] h-[0.12rem] rounded-md bg-gray-100 block mx-auto transition-all duration-300 ease-in-out transform ${
