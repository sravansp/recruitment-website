        ...
        >
                    ...
                    <div className="flex-col justify-start items-start gap-5 flex">
                      ...
                      <div className="flex-col justify-start items-start gap-3.5 flex">
                        <div className="justify-start items-start gap-8 inline-flex">
                          ...
                          >
                            <Radio value={"Between"}>{t("Between")}</Radio>
                            <Radio value={"Greater than and equal to"}>
                              {t("Greater than and equal to")}
                            </Radio>
                            <Radio value={"Less than"}>{t("Less than")}</Radio>
                          </RadioButton>
                        </div>
              ...
              <div className="Card-strech self-stretch h-[362px] flex-col justify-center items-start gap-4 flex">
                <div className="self-stretch h-[270px] px-4 py-6 bg-neutral-50 rounded-lg border border-black border-opacity-5 flex-col justify-center items-start gap-4 flex">
                  ...
                  <div className="flex gap-4">
                    <Button
                      style={{
                        backgroundColor: isButtonActive("paid")
                          ? "#6A4BFC"
                          : "white",
                    ...
                    <Button
                      style={{
                        backgroundColor: isButtonActive("unpaid")
                          ? "#6A4BFC"
                          : "white",
                    ...
                    <Button
                      style={{
                        backgroundColor: isButtonActive("partiallyPaid")
                          ? "#6A4BFC"
                          : "white",
                        color: isButtonActive("partiallyPaid")
                          ? "white"
                          : "black",
                        border: `1px solid ${
          ...
          <div className="card_width_hight self-stretch h-[400px] px-4 py-6 bg-neutral-50 rounded-lg border border-black border-opacity-5 flex-col justify-center items-start gap-4 flex">
            ...
            <div className="w-[811px] text-gray-500 text-xs font-medium font-['Inter'] leading-[18px]">
              <p>
                Set a default rate for leaves when an employee does not match
                any pay rate condition
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <Button
                style={{
                  backgroundColor: isButtonActive("paid1")
                    ? "#6A4BFC"
                    : "white",
              ...
              <Button
                style={{
                  backgroundColor: isButtonActive("unpaid1")
                    ? "#6A4BFC"
                    : "white",
              ...
              <Button
                style={{
                  backgroundColor: isButtonActive("partiallyPaid1")
                    ? "#6A4BFC"
                    : "white",
            ...
            <div className="text-black text-sm font-medium font-['Inter'] leading-tight mt-10">
              How should the daily wage be calculated for unpaid percentage of
              leaves?
            </div>
            <div className="w-[471px] text-gray-500 text-xs font-medium font-['Inter'] leading-[18px]">
